...
const Main = () => {
  ...
  }, []); // ✅ dependency array so it runs only once
  ...
  return (
    <div>
      ...
      <Container sx={{ py: 5 }}>
        ...
        <Typography variant="body1">
          This section captures the history, traditions, and achievements of
          Family One. Explore their journey across generations and their
          contributions to our legacy.
        </Typography>
      </Container>
