...
const OkoliGenTwoProfiles = () => {
  ...
  // ✅ Apply filters: surname = Okoli && generation = 2nd
  useEffect(() => {
    console.log("All data:", originalData);
    console.log("Looking for: Okoli with generation 2nd");
            ...
            {filteredData.length > 0 ? (
              ...
              <Box sx={{ width: "100%", textAlign: "center", py: { xs: 3, sm: 4, md: 5 } }}>
                <Typography variant="body1" color="text.secondary" sx={{ fontSize: { xs: "0.9rem", sm: "1rem", md: "1.1rem" } }}>
                  No members found for Okoli Generation 2
                </Typography>
              </Box>
            )}
          </Grid>
...
export default OkoliGenTwoProfiles;