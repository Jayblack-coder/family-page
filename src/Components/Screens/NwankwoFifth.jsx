...
const NwankwoGenFiveProfiles = () => {
  ...
  // ✅ Apply filters: surname = Nwankwo && generation = 5th
  useEffect(() => {
    console.log("All data:", originalData);
    console.log("Looking for: Nwankwo with generation 5th");
            ...
            {filteredData.length > 0 ? (
              ...
              <Box sx={{ width: "100%", textAlign: "center", py: { xs: 3, sm: 4, md: 5 } }}>
                <Typography variant="body1" color="text.secondary" sx={{ fontSize: { xs: "0.9rem", sm: "1rem", md: "1.1rem" } }}>
                  No members found for Nwankwo Generation 5
                </Typography>
              </Box>
            )}
          </Grid>
